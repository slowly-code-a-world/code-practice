/*
10.1 Imagine you are building some sort of service that will be called by up to 1000
...
you choose.
*/
// hash different stock information onto different machines.
// one stock info only exists on one machine. so that different load is balanced on different machines.
